...
### <a id="chk-1"></a>1. ~/barehands/autodocs.lua:2
`-s` outputs extra stats


### <a id="chk-2"></a>2. ~/barehands/autodocs.lua:89
...
### <a id="chk-3"></a>3. ~/barehands/autodocs.lua:97
...
### <a id="chk-4"></a>4. ~/barehands/autodocs.lua:106
...
### <a id="chk-5"></a>5. ~/barehands/autodocs.lua:136
...
### <a id="chk-6"></a>6. ~/barehands/autodocs.lua:167
...
<a id="chk-7"></a>**7. ~/barehands/autodocs.lua:194**
*↳ [@run 6.](#run-6)*

shell type comments


<a id="chk-8"></a>**8. ~/barehands/autodocs.lua:198**
*↳ [@run 6.](#run-6)*

double-slash comments


<a id="chk-9"></a>**9. ~/barehands/autodocs.lua:203**
*↳ [@run 6.](#run-6)*

double-dash comments


<a id="chk-10"></a>**10. ~/barehands/autodocs.lua:208**
*↳ [@run 6.](#run-6)*

C-style block opening


<a id="chk-11"></a>**11. ~/barehands/autodocs.lua:215**
*↳ [@run 6.](#run-6)*

HTML comment opening


<a id="chk-12"></a>**12. ~/barehands/autodocs.lua:222**
*↳ [@run 6.](#run-6)*

block comment continuation lines


<a id="chk-13"></a>**13. ~/barehands/autodocs.lua:233**
*↳ [@run 6.](#run-6)*

html closing


<a id="chk-14"></a>**14. ~/barehands/autodocs.lua:239**
*↳ [@run 6.](#run-6)*

triple-quote docstring styles


<a id="chk-15"></a>**15. ~/barehands/autodocs.lua:252**
*↳ [@run 6.](#run-6)*
...
### <a id="chk-16"></a>16. ~/barehands/autodocs.lua:286
...
<a id="chk-17"></a>**17. ~/barehands/autodocs.lua:431**
*↳ [@run 7.2](#run-7-2)*

Scan untagged block comment for tags


<a id="chk-18"></a>**18. ~/barehands/autodocs.lua:450**
*↳ [@run 7.2](#run-7-2)*

Scan untagged HTML comment for tags


<a id="chk-19"></a>**19. ~/barehands/autodocs.lua:483**
*↳ [@run 7.2](#run-7-2)*

Scan untagged docstring for tags


<a id="chk-20"></a>**20. ~/barehands/autodocs.lua:508**
*↳ [@run 7.2](#run-7-2)*

Detect comment style of current line


<a id="chk-21"></a>**21. ~/barehands/autodocs.lua:550**
*↳ [@run 7.2](#run-7-2)*

Untagged block comment start - scan for tags


<a id="chk-22"></a>**22. ~/barehands/autodocs.lua:674**
*↳ [@run 9.](#run-9)*

Verify tagged files were discovered


<a id="chk-23"></a>**23. ~/barehands/autodocs.lua:695**
*↳ [@run 9.](#run-9)*

Verify extraction produced results


<a id="chk-24"></a>**24. ~/barehands/autodocs.lua:743**
*↳ [@run 9.](#run-9)*
...
### <a id="def-1"></a>1. ~/barehands/autodocs.lua:10
> [!IMPORTANT]
...
### <a id="def-2"></a>2. ~/barehands/autodocs.lua:31
...
### <a id="def-3"></a>3. ~/barehands/autodocs.lua:43
> [!NOTE]
...
### <a id="def-4"></a>4. ~/barehands/autodocs.lua:49
...
### <a id="def-5"></a>5. ~/barehands/autodocs.lua:126
...
### <a id="def-6"></a>6. ~/barehands/autodocs.lua:129
...
### <a id="def-7"></a>7. ~/barehands/autodocs.lua:132
...
### <a id="def-8"></a>8. ~/barehands/autodocs.lua:266
...
### <a id="def-9"></a>9. ~/barehands/autodocs.lua:280
...
### <a id="def-10"></a>10. ~/barehands/autodocs.lua:301
...
<a id="def-11"></a>**11. ~/barehands/autodocs.lua:308**
*↳ [@run 7.](#run-7)*
...
<a id="def-12"></a>**12. ~/barehands/autodocs.lua:315**
*↳ [@run 7.](#run-7)*
...
### <a id="run-1"></a>1. ~/barehands/autodocs.lua:66
...
### <a id="run-2"></a>2. ~/barehands/autodocs.lua:75
...
### <a id="run-3"></a>3. ~/barehands/autodocs.lua:84
...
### <a id="run-4"></a>4. ~/barehands/autodocs.lua:114
...
### <a id="run-5"></a>5. ~/barehands/autodocs.lua:142
...
<a id="run-7-2"></a>**7.2 ~/barehands/autodocs.lua:373**
*↳ [@run 7.](#run-7)*
...
<a id="run-7-2-1"></a>**7.2.1 ~/barehands/autodocs.lua:393**
*↳ [@run 7.2](#run-7-2)*

Subject line capture mode


<a id="run-7-2-2"></a>**7.2.2 ~/barehands/autodocs.lua:405**
*↳ [@run 7.2](#run-7-2)*

Accumulate C-style block comment with tag


<a id="run-7-2-3"></a>**7.2.3 ~/barehands/autodocs.lua:418**
*↳ [@run 7.2](#run-7-2)*

Accumulate HTML comment with tag


<a id="run-7-2-4"></a>**7.2.4 ~/barehands/autodocs.lua:469**
*↳ [@run 7.2](#run-7-2)*

Accumulate docstring with tag


<a id="run-7-2-5"></a>**7.2.5 ~/barehands/autodocs.lua:511**
*↳ [@run 7.2](#run-7-2)*

Continue or close existing single-line comment block


<a id="run-7-2-6"></a>**7.2.6 ~/barehands/autodocs.lua:526**
*↳ [@run 7.2](#run-7-2)*

Dispatch new tagged comment by style


<a id="run-7-2-7"></a>**7.2.7 ~/barehands/autodocs.lua:563**
*↳ [@run 7.2](#run-7-2)*

Begin subject capture if waiting and hit a code line


### <a id="run-8"></a>8. ~/barehands/autodocs.lua:581
...
### <a id="run-9"></a>9. ~/barehands/autodocs.lua:652
Main function


<a id="run-9-1"></a>**9.1 ~/barehands/autodocs.lua:654**
*↳ [@run 9.](#run-9)*
...
<a id="run-9-2"></a>**9.2 ~/barehands/autodocs.lua:688**
*↳ [@run 9.](#run-9)*
...
<a id="run-9-3"></a>**9.3 ~/barehands/autodocs.lua:706**
*↳ [@run 9.](#run-9)*

Resolve parents, assign per-tag indices, group (single pass)


<a id="run-9-4"></a>**9.4 ~/barehands/autodocs.lua:756**
*↳ [@run 9.](#run-9)*
...
<a id="run-9-5"></a>**9.5 ~/barehands/autodocs.lua:765**
*↳ [@run 9.](#run-9)*
...
### <a id="run-10"></a>10. ~/barehands/autodocs.lua:777
Entry point
...
<a id="err-1"></a>**1. ~/barehands/autodocs.lua:676**
*↳ [@chk 22.](#chk-22)*
...
<a id="err-2"></a>**2. ~/barehands/autodocs.lua:697**
*↳ [@chk 23.](#chk-23)*
